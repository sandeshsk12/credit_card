...
session.execute('create table if not exists ccdp.training_database_2  \
                                ...
                                "Defaulted" float, primary key("ID"))')

session.execute('insert into ccdp.training_database_2 \
...
print(list(session.execute('select * from ccdp.training_database_2')))